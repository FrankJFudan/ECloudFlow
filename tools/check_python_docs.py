...
API_DOC_CONTRACTS: dict[str, APIDocContract] = {
    ...
    "losses.RunningLossScaler.update": APIDocContract(
        True,
        (
            _DEVICE,
            _DTYPE,
    ...
    "losses.compute_ecloudflow_loss": APIDocContract(
        True,
        (
            _DEVICE,
            _DTYPE,
    ...
    "ema.ExponentialMovingAverage.update": APIDocContract(
        True,
        (
            _DEVICE,
            _DTYPE,
    ...
    "module.ECloudFlowTrainingModule.training_step": APIDocContract(
        True,
        (
            _DEVICE,
            _DTYPE,
    ...
    "module.ECloudFlowTrainingModule.optimizer_step": APIDocContract(
        True,
        (
            _DEVICE,
            _DTYPE,
